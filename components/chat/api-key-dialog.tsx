...
export function ApiKeyDialog({ show, onClose, onSuccess }: ApiKeyDialogProps) {
  ...
  return (
    <Dialog open={show} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px] max-w-[95%] h-[90vh] sm:h-auto overflow-y-auto bg-zinc-900/90 backdrop-blur-xl border border-zinc-800 shadow-2xl p-4 sm:p-6">
        <DialogHeader>
          <DialogTitle className="text-xl sm:text-2xl mb-2 sm:mb-4 font-bold text-white">
            Thron AI assistant
          </DialogTitle>
          <DialogDescription className="text-zinc-400 space-y-3 sm:space-y-4 mt-2 sm:mt-4">
            <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-3 sm:p-4">
              <h3 className="font-semibold text-zinc-200 mb-2 flex items-center text-sm sm:text-base">
                <KeyIcon className="w-4 h-4 mr-2" />
                Secure API Key Setup
              </h3>
              <p className="text-xs text-zinc-400">
                To use Thron AI assistant you'll need to provide your API keys.
              ...
              <div className="mt-3 flex flex-col space-y-2 text-xs">
                <div className="text-zinc-600">
                  ...
                  <a
                    href="https://github.com/Thron-Labs/thronai.git"
                    target="_blank"
