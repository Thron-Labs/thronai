            ...
            >
              <div
                className={`
                  ...
                  cursor-default
                  border-[0.5px] border-zinc-700/40
                  ...
                  hover:shadow-[0_2px_4px_0_rgb(0,0,0,0.15)]
                  transition-all
                  duration-300
                  ease-out
                  backdrop-blur-[2px]
                ...
                `}
              >
                <div className="absolute inset-0 bg-gradient-to-br from-transparent via-zinc-800/5 to-zinc-700/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />

                <div className="text-zinc-400/70 group-hover:text-thron/70 transition-colors duration-300 flex items-center pt-0.5">
                  {config.icon}
                </div>

                <div className="flex-1 min-w-0">
                  <div className="text-[13px] leading-[15px] text-white group-hover:text-thron transition-colors duration-300">
                  ...
                  {details.length > 0 && (
                    <p className="mt-2 text-xs text-zinc-400/70 line-clamp-2">
                      {details.join('\n')}
                    </p>
                  )}
